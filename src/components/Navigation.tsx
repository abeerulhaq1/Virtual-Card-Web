    ...
    <nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gold sm:h-10 sm:w-10">
            <span className="text-sm font-bold text-black sm:text-lg">VC</span>
          </div>
        ...
        <div className="flex items-center gap-2">
          {isAuthenticated ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" className="btn-primary px-3 sm:px-6" onClick={() => navigate('/register')}>
                Register
              </Button>
            </div>
          )}
